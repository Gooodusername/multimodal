...
async def test_play_tts():
    ...
    # is_serial:串行执行
    # text:要合成的文本
    block: StartPlayTTS = StartPlayTTS(text="Dear Dolores，when I think of you，I＇m reminded of the beautiful plains of Iowa.The distance between us is breaking my spirit.Falling in love with you was the easiest thing I have ever done.Nothing matters to me but you.And everyday I am alive，I＇m aware of this.I loved you the day I met you，I love you today.And I will love you to rest of my life.")
